...
public class Result implements AnalysisResult {
  ...
  public Result(Kind kind, Position pos, String msg, Iterable<Pair<Position, String>> relatedInfo,
  ...
  public String toString() {
    return "Result [kind=" + kind + ", position=" + position + ", code=" + code + ", message=" + message + ", related="
        + related + ", severity=" + severity + ", repair=" + repair + "]";
  }
